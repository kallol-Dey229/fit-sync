                ...
                {applications?.map((application) => (
                  <Table.Row key={application.id || application._id} className="border-b border-[#111322]/50 hover:bg-[#111322]/30 transition-colors">
                    ...
                    <Table.Cell className="p-4">
                      <span className={`px-2.5 py-0.5 rounded text-[10px] font-black tracking-widest ${roleStyles[applications.role] || roleStyles.USER}`}>
                        {applications.role}
                      </span>
                    </Table.Cell>
                    ...
                    <Table.Cell className="p-4">
                      <span className={`px-2.5 py-0.5 rounded text-[10px] font-black tracking-widest ${statusStyles[applications.status] || statusStyles.ACTIVE}`}>
                        {applications.status}
                      </span>
                    </Table.Cell>
