            ...
            <div className="w-full max-w-5xl space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                    ...
                    <Card className="md:col-span-5 bg-[#06081f] border border-[#222538] rounded-2xl p-6 flex flex-col justify-between gap-5">
                        ...
                        <Card.Footer className="p-0 w-full flex flex-col gap-2">
                            {error && (
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-[#FF4500] hover:bg-[#E03D00] disabled:opacity-60 disabled:cursor-not-allowed text-white font-black rounded-lg flex items-center justify-center gap-3 px-4 py-3 hover:cursor-pointer"
                            >
                                <Lock size={14} />
